    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="relative">
        <Input
          ...
          className="pr-10 border-zinc-200 focus:bg-white focus:border-accent focus-visible:ring-0 focus-visible:ring-offset-0 transition-colors"
        />
        <button
          type="button"
          onClick={addSubtask}
              ...
              >
                ...
                <div className="flex-1 relative">
                  <Input
                    ...
                    className={`pr-8 h-9 border-zinc-200 bg-white focus:bg-white focus:border-accent focus-visible:ring-0 focus-visible:ring-offset-0 text-sm transition-all ${
                      subtask.completed 
