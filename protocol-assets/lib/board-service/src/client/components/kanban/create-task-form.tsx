        ...
        <CardContent className="space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              required
              className="h-11 border-zinc-200 focus:bg-white focus:border-accent focus:ring-0 transition-colors"
            />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              rows={4}
              className="border-zinc-200 focus:bg-white focus:border-accent focus:ring-0 transition-colors resize-none"
            />
          </div>
