-- Add 'code_review' status to the tasks table status constraint
-- We'll create a new table without the problematic PRAGMA statements

-- Drop the view that depends on tasks table
DROP VIEW IF EXISTS tasks_with_dependencies;

-- Create new tasks table with updated constraint to include 'code_review'
