...
const CONFIG_SCHEMA = {
  ...
  // Services - ports and URLs must be provided via environment
  TASK_SERVICE_URL: {
    type: 'url',
    required: true
  },
...
function getServiceConfig(serviceName) {
  ...
  switch (serviceName) {
    ...
    case 'board-api':
      ...
      if (!process.env.HOST || !process.env.PORT || !process.env.FRONTEND_PORT) {
        throw new Error('Missing required environment variables: HOST, PORT, FRONTEND_PORT must be set');
      }
      ...
      return {
        ...
        // Dynamic CORS origins based on frontend port
        ALLOWED_ORIGINS: [
